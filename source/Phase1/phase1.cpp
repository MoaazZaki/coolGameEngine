...
void famm::PhaseOneApplication::onDraw(double deltaTime)  {
    ...
    if (!isPaused) {
        if (deviceManager->pressedActionChecker(famm::ControlsActions::DOWN, famm::PressModes::IS_PRESSED)) currentShape = 2;
        else if (deviceManager->pressedActionChecker(famm::ControlsActions::LEFT, famm::PressModes::IS_PRESSED)) currentShape = 3;
        else if (deviceManager->pressedActionChecker(famm::ControlsActions::RIGHT, famm::PressModes::IS_PRESSED)) currentShape = 4;
        else if (deviceManager->pressedActionChecker(famm::ControlsActions::UP, famm::PressModes::IS_PRESSED)) currentShape = 1;
    }
