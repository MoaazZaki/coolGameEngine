...
void famm::GameMenu::onInitialize() {
...
void famm::GameMenu::onDraw(double deltaTime) {
...
void famm::GameMenu::onImmediateGui(ImGuiIO* io) {
...
void famm::GameMenu::onPause() {
    isPaused = true;
}

void famm::GameMenu::onResume() {
    isPaused = false;
}

bool famm::GameMenu::statePaused()
{
    return isPaused;
}

bool famm::GameMenu::stateTerminated()
{
    return isTerminated;
}